...
Funktionaltitäten des aktuellen \passthrough{\lstinline!5.15!} Kernel
besitzt. In diesem fiktiven Beispiel, wird die
\passthrough{\lstinline!systemd-networking!} Funktionalität für das
Batman-Prokoll benötigt, welche den Grund für die Umstellung darstellt
und nicht trivial in den \passthrough{\lstinline!4.x!} Kernel integriert
werden kann.
