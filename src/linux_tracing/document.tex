...
Aktion die Ausgeführt wird von hoher Bedeutung. Moderne Linux Systeme
sind sehr komplex und bestehen aus vielen Softwaremodulen, welche auf
unterschiedlichesten Weißen untereinander interagieren. Um zu verstehen
warum gewisse Aktionen ausgeführt werden, ist es wichtig Systemnah
debuggen und diese analysieren zu können. Oft können Fehler repoduziert
und mit solchen Anaylsen identifiziert werden. Zusätzlich besteht bei
Custom Driver die Möglichkeit während des bootvorgangs zu debuggen.
