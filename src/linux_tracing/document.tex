...
\hypertarget{beispiel-fuxfcr-events}{%
\section{Beispiel für Events}\label{beispiel-fuxfcr-events}}
...
\chapter{Tracing auf Mikrokontrollern
?????}\label{tracing-auf-mikrokontrollern}}
...
erfolgt als Tabelle in der Konsole und ist somit rein Textbasiert.
...
\hypertarget{netzwerk-paketanalyse-beispiel}{%
\subsection{Netzwerk Paketanalyse
Beispiel}\label{netzwerk-paketanalyse-beispiel}}
