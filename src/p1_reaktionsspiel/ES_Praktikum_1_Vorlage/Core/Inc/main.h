...
void switch_all_leds(uint8_t ENorDI, uint32_t delay);
void led_new_game();
/* USER CODE END EFP */
...
#define TIM7OUT_Pin GPIO_PIN_1
#define TIM7OUT_GPIO_Port GPIOC
#define RNGOUT_Pin GPIO_PIN_2
#define RNGOUT_GPIO_Port GPIOC
...
#define USERTIME_Pin GPIO_PIN_4
#define USERTIME_GPIO_Port GPIOC
#define BTNTRG_Pin GPIO_PIN_5
#define BTNTRG_GPIO_Port GPIOC
...
#define STATUS_START_NEW_GAME 			0
#define STATUS_RANDOM_TIMER_READY		1
#define STATUS_RANDOM_TIMER_RUNNING		2
#define STATUS_RANDOM_TIMER_EXPIRED		3
#define STATUS_MEASURE_REACTION_TIME 	4
